...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="gradient-hero min-h-[60vh] sm:min-h-[70vh] md:min-h-[100vh] flex items-center justify-center relative overflow-hidden">
      {/* Parallax Background */}
      <div
        className="absolute inset-0"
        style={{ transform: `translateY(${scrollY * 0.5}px)`, background: '#000000' }}
      >
        <img
          src={brasilLogo}
          alt="Brasil Logo"
